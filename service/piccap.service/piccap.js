...
*/
var pkgInfo = __webpack_require__(/*! ./package.json */ "./package.json");

var Service = __webpack_require__(/*! webos-service */ "webos-service");

var service = new Service(pkgInfo.name);

var regeneratorRuntime = __webpack_require__(/*! regenerator-runtime */ "./node_modules/regenerator-runtime/runtime.js");

var fsSync = __webpack_require__(/*! fs */ "fs");

var _require = __webpack_require__(/*! bluebird */ "./node_modules/bluebird/js/release/bluebird.js"),
    Promise = _require.Promise;

var readFile = Promise.promisify(fsSync.readFile);
var writeFile = Promise.promisify(fsSync.writeFile);
var unlinkFile = Promise.promisify(fsSync.unlink);
...
var libvtcapturepath = "/media/developer/apps/usr/palm/services/org.webosbrew.piccap.service/hyperion-webos_libvtcapture";
var libvtpath = "/media/developer/apps/usr/palm/services/org.webosbrew.piccap.service/hyperion-webos_libvt";
var setloaded = false;
var started = false;
var isRoot = false;
var hasCapturePerms = false;
var capturePermsNeeded = false;
var setcounter = 0;
var scriptrun = false;
startup();
...
function _startup() {
  _startup = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 15:
            ...
            console.log("Autostart enabled! Checking if Hyperion-WebOS has to be started.."); //Do autostart things
...
function checkRoot() {
  return _checkRoot.apply(this, arguments);
}

function _checkRoot() {
  _checkRoot = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
...
function getRootStatus(_x) {
  return _getRootStatus.apply(this, arguments);
}

function _getRootStatus() {
  _getRootStatus = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(message) {
    var perm;
...
function flagRead(_x2) {
  return _flagRead.apply(this, arguments);
}

function _flagRead() {
  _flagRead = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(flag) {
    var fread;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return _context4.abrupt("return", "flagnotfound");

          case 3:
            _context4.prev = 3;
            _context4.next = 6;
            return readFile(flagPath(flag), "utf-8");

          case 6:
            fread = _context4.sent;
            _context4.next = 12;
            break;
          ...
          case 12:
            return _context4.abrupt("return", fread);
...
function flagSave(_x3, _x4) {
  return _flagSave.apply(this, arguments);
}

function _flagSave() {
  _flagSave = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(flag, data) {
    var fsave;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return _context5.abrupt("return", "flagnotfound");

          case 3:
            _context5.prev = 3;
            _context5.next = 6;
            return writeFile(fsave, data, "utf-8");
          ...
          case 13:
            return _context5.abrupt("return", fsave);
...
function flagUnlink(_x5) {
  return _flagUnlink.apply(this, arguments);
}

function _flagUnlink() {
  _flagUnlink = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(flag) {
    var funlink;
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            funlink = flagPath(flag);
            ...
            return _context6.abrupt("return", "flagnotfound");

          case 3:
            _context6.prev = 3;
            _context6.next = 6;
            return unlinkFile(funlink);
          ...
          case 9:
            ...
            funlink = _context6.t0;

          case 12:
            return _context6.abrupt("return", funlink);
...
function _loadSettings() {
  _loadSettings = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
...
function setSettings(_x6) {
  return _setSettings.apply(this, arguments);
}

function _setSettings() {
  _setSettings = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(message) {
...
function saveSettings(_x7) {
  return _saveSettings.apply(this, arguments);
}

function _saveSettings() {
  _saveSettings = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(message) {
    var out, error;
...
function resetSettings(_x8) {
  return _resetSettings.apply(this, arguments);
}

function _resetSettings() {
  _resetSettings = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(message) {
    var out, error, f1;
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            ...
            error = "no";
            _context10.t0 = regeneratorRuntime.keys(availableFlags);
          ...
          case 3:
            ...
            f1 = _context10.t1.value;
            _context10.next = 7;
            return flagUnlink(f1);
...
function hyperionstart() {
  return _hyperionstart.apply(this, arguments);
}

function _hyperionstart() {
  _hyperionstart = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee11() {
    var execparameter, hbcapturestartcmd;
...
function hyperionstop() {
  return _hyperionstop.apply(this, arguments);
}

function _hyperionstop() {
  _hyperionstop = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee12() {
    var hbcapturestopcmd;
    return regeneratorRuntime.wrap(function _callee12$(_context12) {
      while (1) {
        switch (_context12.prev = _context12.next) {
          case 0:
            hbcapturestopcmd = "pidof -s hyperion-webos_libvt | xargs kill -SIGTERM";
...
function _stopService() {
  _stopService = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee14() {
...
function isHyperionStarted() {
  return _isHyperionStarted.apply(this, arguments);
}

function _isHyperionStarted() {
  _isHyperionStarted = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee15() {
...
function isStarted(_x9) {
  return _isStarted.apply(this, arguments);
}

function _isStarted() {
  _isStarted = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee16(message) {
...
function getCapturePermsStatus() {
  return _getCapturePermsStatus.apply(this, arguments);
}

function _getCapturePermsStatus() {
  _getCapturePermsStatus = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee17() {
    return regeneratorRuntime.wrap(function _callee17$(_context17) {
      while (1) {
        switch (_context17.prev = _context17.next) {
          case 0:
            hasCapturePerms = false; //File /usr/share/luna-service2/roles.d/org.webosbrew.piccap.service.role.json existing?
            ...
            _context17.prev = 2;
            _context17.next = 5;
            return accessFile("/usr/share/luna-service2/roles.d/org.webosbrew.piccap.service.role.json", fsSync.constants.F_OK);
          ...
          case 7:
            ...
            console.log("/usr/share/luna-service2/roles.d/org.webosbrew.piccap.service.role.json not found. Assuming permissions not enforced. Error: " + _context17.t0);
...
function areCapturePermsNeeded() {
  return _areCapturePermsNeeded.apply(this, arguments);
}

function _areCapturePermsNeeded() {
  _areCapturePermsNeeded = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee18() {
    var found1, found2;
      ...
      while (1) {
        switch (_context18.prev = _context18.next) {
          case 0:
            ...
            _context18.prev = 4;
            _context18.next = 7;
            return accessFile("/usr/lib/libvtcapture.so.1", fsSync.constants.F_OK);
          ...
          case 9:
            ...
            found1 = false;
            console.log("/usr/lib/libvtcapture.so.1 not found. Error: " + _context18.t0);

          case 13:
            _context18.prev = 13;
            _context18.next = 16;
            return accessFile("/usr/lib/libvtcapture.so.1.0.0", fsSync.constants.F_OK);
          ...
          case 18:
            ...
            found2 = false;
            console.log("/usr/lib/libvtcapture.so.1.0.0 not found. Error: " + _context18.t1);
    ...
    }, _callee18, null, [[4, 9], [13, 18]]);
  }));
  return _areCapturePermsNeeded.apply(this, arguments);
}

function doPermScript() {
  return _doPermScript.apply(this, arguments);
}

function _doPermScript() {
  _doPermScript = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee19() {
        ...
        switch (_context19.prev = _context19.next) {
          case 0:
            ...
            service.call("luna://org.webosbrew.hbchannel.service/exec", {
              ...
              console.log("HBChannel exec returns: " + message.payload.stdoutString);
              console.log("HBChannel exec stderr returns: " + message.payload.stderrString); //Maybe some script errorhandling in future
...
function setCapturePerms(_x10) {
  return _setCapturePerms.apply(this, arguments);
}

function _setCapturePerms() {
  _setCapturePerms = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee20(message) {
...
function dummystart(_x11) {
  return _dummystart.apply(this, arguments);
}

function _dummystart() {
  _dummystart = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee21(message) {
...
function dummystop(_x12) {
  return _dummystop.apply(this, arguments);
}

function _dummystop() {
  _dummystop = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee22(message) {
